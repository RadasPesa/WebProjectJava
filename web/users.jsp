...
<%
    ...
    if (role != 1) {
        throw new IllegalAccessException("Insufficient permission to view this site.");
    }
%>
<header>
    <div class="container">
...
<div class="container">
    ...
    <div class="middlePanel">
        <%
            List<WebUserEntity> users = UserBO.getRegisteredUsers();
            for (WebUserEntity user : users) {%>
                Username: <%=user.getNickname()%> <br />
                Registered: <%=user.getRegistrationDate().toLocalDateTime().format(format)%> <br />
                <a href="profile.jsp?manage=<%=user.getNickname()%>">Manage profile</a> <br />
                <hr />
        <%}%>
    </div>
    <div class="rightPanel">
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="DeleteCommentServlet" method="post">
                        ...
                        <input type="hidden" name="actualPage" value="users.jsp"/>
                        <script>
        ...
        <form action="CommentServlet" method="post">
            ...
            <input type="hidden" name="currentPage" value="users.jsp"/>
